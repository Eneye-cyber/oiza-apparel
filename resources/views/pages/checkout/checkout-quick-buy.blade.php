              ...
              <div class="space-y-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3">
                      <div class="relative">
                        <img src="{{ $item->variant['media_url'] ?? $item->product['cover_media_url'] ?? '/placeholder.svg' }}"
                      ...
                      <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium truncate">{{  $item->variant?->name ?? $item->product->name }}</p>
                        <p class="text-sm text-black opacity-60">₦{{ number_format($item->variant['price'] ?? $item->product['discount_price'] ?? $item->product['price'], 2) }}</p>
                      </div>
