        ...
        <div class="container">
            <div class="grid md:grid-cols-2 gap-6">
                <div class="flex flex-col justify-center items-start gap-5 text-left">
                    <h1 class=" text-6xl md:text-[90px] lg:text-[120px] leading-[0.9] text-primary drop-shadow-sm drop-shadow-primary/20 font-playfair-display mt-5 mb-2.5"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex flex-col" data-aos="fade-up">
                        <div class="object-fit overflow-clip mt-auto relative">
                            <img class="object-cover xl:h-[436px] drop-shadow-2xl" src="{{ asset('img/hero_3.jpg') }}"
                                alt="hero-1" loading="eager" width="308" height="450">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3.5" data-aos="fade-down">
                        <div class="flex-1">
                            <div class="object-fit overflow-clip relative">
                                ...
                                <img class="max-sm:h-[249px] object-fill drop-shadow-2xl"
                                    src="{{ asset('img/hero_2.jpg') }}" alt="hero-2" loading="eager" width="308"
                                    height="498">
                            </div>
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            ...
            <article data-aos="zoom-in-right" data-aos-anchor-placement="top-bottom"
                ...
                <div class="promo-content">
                    ...
                    <a href="/shop/fabric/lace/brocade"
                        class="flex flex-center gap-2 transition-all group hover:text-primary">
                ...
                <figure class="promo-image group-hover:scale-105">
                    <img class="max-w-full object-cover inline-block" src="{{ asset('img/mask.png') }}"
                        alt="Luxury Brocade Dress" width="260" height="413" loading="lazy" />
                </figure>
            </article>
    ...
    <article class="max-md:pt-4 py-8">
        <div class="container">
            ...
            <section role="list" id="products-listing"
                class="product-list grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 py-8" data-aos="fade-up"
                data-aos-delay="200">
