        ...
        <div class="container">
            ...
            <section class="pt-2">
                <div class="flex justify-between items-center">
                    ...
                    <nav class="flex items-center uppercase font-medium" aria-label="Main navigation">
                        ...
                        <div class="px-6">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center gap-3 text-13">
                                    ...
                                    <a href="https://www.facebook.com/oiza_apparel/" target="_blank" rel="noopener noreferrer" class="text-black hover:text-[#555] hover:underline">Facebook</a>
                                </div>
                                <div class="flex items-center gap-3 text-13">
